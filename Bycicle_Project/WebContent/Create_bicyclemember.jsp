...
<body>
	...
	<form method="post" action="update_bicyclemember.jsp" id="login">
		...
		<pre>아이디: <input type= "text" name="id" id="id" maxlength="12" required autocomplete = "off"> <input type = "button" value = "ID 중복확인" onclick = "idCheck()"></pre>
		...
		<!-- placeholder="000*-000*-0000" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{3,4}"  -->
