...
<body>
	...
	<form method="post" action="update_bicyclemember.jsp" id="login">
		...
		<pre >종류 : <input type="radio" name="usetype" id="MTB" value="0"> <label for="MTB">MTB</label> <input type="radio" name="usetype" id = "road" value="1"><label for="rord">로드</label> <input type="radio" name="usetype" id = "hybri" value="2"> <label for="bybri">하이브리드</label></pre>
		<pre>전화번호 :   <input type="tel" name="tel" id="tel" maxlength="13" placeholder="000-0000-0000" pattern="[0-9]{2,3}-\d{3,4}-\d{4}" required title="000-0000-0000"><br/></pre>
