var f_baby= document.getElementById("f_girl");//이동함수 구현을 위한 f_girl 불러오기
$(document).ready(function(){//f_girl이 불렸을 경우 실행창
  animateDiv($('#f_girl'));
});

function makeNewPosition($container_baby){//container_girl내의 이동 범위지정
  var h = $container_baby.height() - 10;
  var w = $container_baby.width() - 10;
...
function animateDiv($target){//f_girl 이동범위 설정
